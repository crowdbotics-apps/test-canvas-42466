"""
Django settings for test_canvas_42466 project.
...
ROOT_URLCONF = 'test_canvas_42466.urls'
...
WSGI_APPLICATION = 'test_canvas_42466.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_canvas_42466 API",
    "DESCRIPTION": "API documentation for test_canvas_42466 App",
    "VERSION": "v1",
}
