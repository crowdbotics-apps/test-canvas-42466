...
export const modules_disqus_comment_like_list = createAsyncThunk("paginatedLikeOnCommentLists/modules_disqus_comment_like_list", async payload => {
...
const paginatedLikeOnCommentListsSlice = createSlice({
  ...
  extraReducers: builder => {
    builder.addCase(modules_disqus_comment_like_list.pending, (state, action) => {
