...
export const api_v1_profile_list = createAsyncThunk("profiles/api_v1_profile_list", async payload => {
  const response = await apiService.api_v1_profile_list(payload);
  return response.data;
});
export const api_v1_profile_create = createAsyncThunk("profiles/api_v1_profile_create", async payload => {
  const response = await apiService.api_v1_profile_create(payload);
  return response.data;
});
export const api_v1_profile_retrieve = createAsyncThunk("profiles/api_v1_profile_retrieve", async payload => {
  const response = await apiService.api_v1_profile_retrieve(payload);
  return response.data;
});
export const api_v1_profile_update = createAsyncThunk("profiles/api_v1_profile_update", async payload => {
  const response = await apiService.api_v1_profile_update(payload);
  return response.data;
});
export const api_v1_profile_partial_update = createAsyncThunk("profiles/api_v1_profile_partial_update", async payload => {
  const response = await apiService.api_v1_profile_partial_update(payload);
  return response.data;
});
export const api_v1_profile_destroy = createAsyncThunk("profiles/api_v1_profile_destroy", async payload => {
...
const profilesSlice = createSlice({
  ...
  extraReducers: builder => {
    builder.addCase(api_v1_profile_list.pending, (state, action) => {
